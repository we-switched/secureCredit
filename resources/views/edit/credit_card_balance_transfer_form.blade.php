...
<div class="container" style="margin-top: 20px">
    <form method="POST" action="{{ url('/credit_card_balance_transfer_form/'.$loan->id) }}" style="color: whitesmoke">
    @method('PUT')
        @csrf
        ...
        <div class="form-group" id="modeofsalary" style="display: none">
            ...
            <select class="custom-select custom-mine" name="modeofsalary">
                <option value="">Choose ...</option>
                <optgroup label="Mode">
        ...
        <div class="form-group" id="netsalary" style="display: none">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('netsalary') is-invalid @enderror" placeholder="Enter net take home salary" name="netsalary" value="{{ old('netsalary', $loan->netsalary) }}">
            @error('netsalary')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group" id="profit" style="display: none">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('profit') is-invalid @enderror" placeholder="Enter net proft as per last year ITR" name="profit" value="{{ old('profit', $loan->profit) }}">
            @error('profit')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group" id="turnover" style="display: none">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('turnover') is-invalid @enderror" placeholder="Enter gross turnover as per last year ITR" name="turnover" value="{{ old('turnover', $loan->turnover) }}">
            @error('turnover')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('noofcards') is-invalid @enderror" id="noofcards" placeholder="Enter total no. of cards owned by you" name="noofcards" value="{{ old('noofcards', $loan->noofcards) }}" required>
            @error('noofcards')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('totalcreditlimit') is-invalid @enderror" id="totalcreditlimit" placeholder="Enter total credit limit on all cards" name="totalcreditlimit" value="{{ old('totalcreditlimit', $loan->totalcreditlimit) }}" required>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('currentoutstanding') is-invalid @enderror" id="currentoutstanding" placeholder="Enter current outstanding in all cards" name="currentoutstanding" value="{{ old('currentoutstanding', $loan->currentoutstanding) }}" required>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="delayinpayment" id="delayinpaymentyes" value="Yes" {{ old('delayinpayment', $loan->delayinpayment) == "Yes" ? 'checked' : '' }}>
            <label class="form-check-label" for="delayinpaymentyes">Yes</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="delayinpayment" id="delayinpaymentno" value="No" {{ old('delayinpayment', $loan->delayinpayment) == "No" ? 'checked' : '' }}>
