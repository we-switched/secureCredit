...
<div class="text-center"><h3 style="color: whitesmoke">Apply for Personal Loan</h3></div>
<div class="container" style="margin-top: 20px">
    <form method="POST" action="{{ url('/personal_loan_first_form') }}" style="color: white">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <div class="form-check form-check-inline">
                            ...
                            <label class="col-md-2 control-label" for="existingloansyes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            ...
                            <label class="col-md-2 control-label" for="existingloansno">No</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <div class="form-check form-check-inline">
                            ...
                            <label class="col-md-2 control-label" for="salaried">Salaried</label>
                        </div>
                        <div class="form-check form-check-inline">
                            ...
                            <label class="col-md-4 control-label" for="selfemployed">Self Employed</label>
                        </div><br>
                    </div>
                </div>
                ...
                <div class="form-group" id="id_modeofsalary" style="display: none">
                    ...
                    <div class="col-md-8 inputGroupContainer">
                        <div class="input-group">
                            <select class="custom-select custom-mine selectpicker form-control" name="modeofsalary" id="modeofsalary">
                                <option value="">Choose ...</option>
                                <optgroup label="Mode">
                                    ...
                                    <option value="Bank" onclick="checkBank()">Bank</option>
                                </optgroup>
                            </select>
                        </div>
                    </div>
        ...
        <div class="form-check">
            ...
            <label for="proceed"><small>By submitting, you agree to the <a href="{{ url('/info#privacy_policy') }}" target="blank" style="text-decoration: none; color: whitesmoke"><b>Terms and Conditions</b></a> of Secure Credit & its representatives to contact you.</small></label>
        </div>
    ...
    <script>
        ...
        function checkBank(){
            document.getElementById("id_bankSelection").style.display = "none";
        }
