...
<div class="container" style="margin-top: 20px">
    <form method="POST" action="{{ url('/instant_loan_form/'.$loan->id) }}" style="color: whitesmoke">
    @method('PUT')
        @csrf
        ...
        <div class="form-group">
        <label>Do you have Aadhar linked Mobile No. ?</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="aadharmobile" value="No" {{ old('aadharmobile', $loan->aadharmobile) == "No" ? 'checked' : '' }}>
                <label class="form-check-label" for="aadharmobileno">No</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="aadharmobile" value="Yes" {{ old('aadharmobile', $loan->aadharmobile) == "Yes" ? 'checked' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" class="form-control custom-mine @error('netincome') is-invalid @enderror" id="netincome" placeholder="Enter net monthly income" name="netincome" value="{{ old('netincome', $loan->netincome) }}">
            @error('netincome')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
            <label>Do you have internet banking access for your savings account ?</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="bankingaccess" value="No" {{ old('bankingaccess', $loan->bankingaccess) == "No" ? 'checked' : '' }}>
                <label class="form-check-label" for="bankingaccessno">No</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="bankingaccess" value="Yes" {{ old('bankingaccess', $loan->bankingaccess) == "Yes" ? 'checked' : '' }}>
