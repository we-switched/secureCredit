...
<section class="section section bg-soft pb-5 overflow-hidden z-2">
    <div class="container z-2">
        <div class="mt-6 mb-5">
            <h1 class="font-weight-light">Apply for <span class="font-weight-bold">Insurance</span></h1>
        </div>
    <form method="POST" action="{{url('/insurance_form')}}">
        @csrf
        ...
        <p><b>Type of Insurance</b></p>
        <select class="custom-select custom-mine" name="type" id="type" required>
            <option value="">Choose ...</option>
            <option value="Health Insurance" {{ old('type') == 'Health Insurance' ? 'selected' : '' }}>Health Insurance</option>
            <option value="Life Insurance" {{ old('type') == 'Life Insurance' ? 'selected' : '' }}>Life Insurance</option>
            <option value="Car Insurance" {{ old('type') == 'Car Insurance' ? 'selected' : '' }}>Car Insurance</option>
            <option value="Two-Wheeler Insurance" {{ old('type') == 'Two-Wheeler Insurance' ? 'selected' : '' }}>Two-Wheeler Insurance</option>
            <option value="Travel Insurance" {{ old('type') == 'Travel Insurance' ? 'selected' : '' }}>Travel Insurance</option>
            <option value="Commercial Insurance" {{ old('type') == 'Commercial Insurance' ? 'selected' : '' }}>Commercial Insurance</option>
        </select><br><br>
