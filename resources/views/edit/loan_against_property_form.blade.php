...
<div class="container" style="margin-top: 20px">
    <form method="POST" action="{{ url('/loan_against_property_form/'.$loan->id) }}" style="color: whitesmoke">
    @method('PUT')
        @csrf
        ...
        <div class="form-group">
            ...
            <select class="custom-select custom-mine" name="typeofproperty" required>
                <option selected>Choose ...</option>
                <option value="Individual House" {{ old('typeofproperty', $loan->typeofproperty) == "Individual House" ? 'selected' : '' }}>Individual House</option>
                <option value="Commercial Buildings" {{ old('typeofproperty', $loan->typeofproperty) == "Commercial Buildings" ? 'selected' : '' }}>Commercial Buildings</option>
                <option value="Commercial Plots" {{ old('typeofproperty', $loan->typeofproperty) == "Commercial Plots" ? 'selected' : '' }}>Commercial Plots</option>
                <option value="Flat" {{ old('typeofproperty', $loan->typeofproperty) == "Flat" ? 'selected' : '' }}>Flat</option>
                <option value="Plots" {{ old('typeofproperty', $loan->typeofproperty) == "Plots" ? 'selected' : '' }}>Plots</option>
                <option value="Residential Rental Income Building" {{ old('typeofproperty', $loan->typeofproperty) == "Residential Rental Income Building" ? 'selected' : '' }}>Residential Rental Income Building</option>
                <option value="Other" {{ old('typeofproperty', $loan->typeofproperty) == "Other" ? 'selected' : '' }}>Other</option>
            </select><br>
        </div>
