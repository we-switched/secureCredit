...
@section('title', 'Invoice Discounting')
...
<section class="section section bg-soft pb-5 overflow-hidden z-2">
    <div class="container z-2">
        <div class="mt-6 mb-5">
            <h1 class="font-weight-light">Apply for <span class="font-weight-bold">Invoice Discounting</span></h1>
        </div>
    <form method="POST" action="{{url('/invoice_discounting_form')}}">
        @csrf
